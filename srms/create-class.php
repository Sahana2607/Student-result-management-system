...
<html lang="en">
    <head>
        ...
        <title>SMS Admin Create SEM</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Create Student SEM</h2>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">SEM Name</label>
                                                		<div class="">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">SEM Name in Numeric</label>
                                                        <div class="">
                                                     ...
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- ISE ,CSE ,ECE etc</span>
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
